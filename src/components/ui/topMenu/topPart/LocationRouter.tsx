...
import { StartLocationSearchField } from "../components/StartLocationSearchField";
...
export const LocationRouter: React.FC<PathFinderProps> = ({
  ...
  return (
    <div
      className="relative"
      aria-label="Location router panel (top part)"
      aria-describedby="location-router-top-desc"
    >
      {/* Description for screen readers */}
      <div id="location-router-top-desc" className="sr-only">
        This panel allows you to select start and end locations and find
        navigation paths from the top bar controls.
      </div>
