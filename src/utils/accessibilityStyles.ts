...
export const getStartLocationStyles = (settings?: AccessibilitySettings) => {
  ...
  return {
    ...
    inputBorder: `border-${inputBorderWidth} border-${highContrast ? "green-600" : "green-500"}`,
    buttonBg: highContrast ? "bg-green-700 hover:bg-green-800" : "bg-green-500 hover:bg-green-600",
    buttonText: "text-white",
    dropdownBg: highContrast ? "bg-gray-900" : "bg-white",
    dropdownBorder: `border-${inputBorderWidth} border-${highContrast ? "green-600" : "green-500"}`,
    ...
    highlightBadge: highContrast ? "bg-green-800 text-white font-bold" : "bg-green-100 text-green-800",
...
export const getEndLocationStyles = (settings?: AccessibilitySettings) => {
  ...
  return {
    ...
    inputBorder: `border-${inputBorderWidth} border-${highContrast ? "red-600" : "red-500"}`,
    buttonBg: highContrast ? "bg-red-700 hover:bg-red-800" : "bg-red-500 hover:bg-red-600",
    buttonText: "text-white",
    dropdownBg: highContrast ? "bg-gray-900" : "bg-white",
    dropdownBorder: `border-${inputBorderWidth} border-${highContrast ? "red-600" : "red-500"}`,
    dropdownItemHover: highContrast ? "hover:bg-gray-700" : "hover:bg-red-50",
    resultText: `${textColor} font-bold`,
    resultDetailText: textColor,
    highlightBadge: highContrast ? "bg-red-800 text-white font-bold" : "bg-red-100 text-red-800",
    iconColor: "text-white",
  };
};
...
export const getSearchStyles = (settings?: AccessibilitySettings) => {
  ...
  return {
    labelText: highContrast ? "text-gray-100 font-bold text-2xl" : "text-gray-200",
    inputBg: highContrast ? "bg-gray-100" : "bg-white",
    inputText: highContrast ? "text-gray-900 font-bold" : "text-gray-800",
    inputBorder: highContrast ? "border-3 border-blue-600" : "border border-gray-300",
    buttonBg: highContrast ? "bg-blue-700" : "bg-blue-600 hover:bg-blue-700",
    buttonText: "text-white" + (highContrast ? " font-bold" : ""),
    dropdownBg: highContrast ? "bg-gray-900" : "bg-white",
    dropdownBorder: highContrast ? "border-3 border-blue-600" : "border border-gray-300",
    ...
    highlightBadge: highContrast ? "bg-blue-700 text-white font-bold right-0" : "bg-blue-100 text-blue-800",
    iconColor: "text-white",
  };
};
